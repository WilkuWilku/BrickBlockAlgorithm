...
public class CrossBlock extends AbstractBlockType2or1{
    private static final int[][] shapeR0 = new int[][]{{1,0}, {0,1}, {1,1}, {1,2}, {1,3}, {2,1}};
    private static final int[][] shapeR90 = new int[][]{{2,0}, {0,1}, {1,1}, {2, 1}, {3, 1}, {2,2}};
    private static final int[][] shapeR180 = new int[][]{{1,0}, {1,1}, {1,2}, {1, 3}, {0, 2}, {2,2}};
    private static final int[][] shapeR270 = new int[][]{{1,0}, {0,1}, {1,1}, {2, 1}, {3, 1}, {1,2}};
